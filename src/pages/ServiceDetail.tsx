    ...
    return (
      <div className={styles.pageContainer}>
        ...
        <div className={styles.notFound}>
          ...
          <Link to="/services" className={styles.primaryBtn}>Return to Services</Link>
        </div>
        <Footer />
      </div>
    )
      ...
      <div className={styles.contentContainer}>
        <div className={styles.card}>
          ...
          <div className={styles.verseBox}>
            <p className={styles.verseText}>"{service.verseText}"</p>
          ...
          <div className={styles.actions}>
            <button className={styles.primaryBtn} onClick={() => {
              alert('The live stream link is not yet active. Please check back closer to the service time!');
            }}>
              Join Live Stream
            </button>
