...
export default function Services({ services }: ServicesProps) {
  ...
  // show Youth Online Connect as a reliable fallback.
  const fallbackServices: Service[] = [
    {
      id: 'youth-online-connect',
      name: 'Youth Online Connect',
      day: 'Tuesday',
      time: '8:30 PM - 9:30 PM',
      description:
        'Youth online fellowship every Tuesday 8:30 PM – 9:30 PM.',
      platform: 'Online',
      venue: 'Online',
    },
  ]
  ...
  const featuredCards = [
    {
      ...
      who: "Open to Everyone (Children's Ministry 9:00–11:00 AM)",
    },
    {
      id: SERVICE_SLUGS.wednesdayPrayers,
      title: 'Wednesday Midweek Prayers',
      image: '/midweek-prayers-wednesday.jpeg',
      description: 'Midweek physical prayer gathering to seek God together on site.',
    ...
    },
    {
      ...
      description: 'Friday all-night prayer and worship from 8:00 PM until dawn.',
      cta: 'Join Tefila Night',
      time: 'Every Friday | 8:00 PM until Dawn',
      location: 'VOSH Kitengela Main Sanctuary',
      expect: "Extended Worship, Intercession, and Encountering God's Presence.",
